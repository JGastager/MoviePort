<template>
    <div>
        ...
        <TransitionSlide appear group tag="div" class="w-screen flex items-start gap overflow-x-auto overflow-y-hidden px-22.5 -mx-22.5">
            <div v-for="(movie, index) in movies" :key="index" class="group relative cursor-pointer rounded">
                <div class="w-custom relative mb-3 aspect-2/3 overflow-hidden card">
...
<style lang="scss">
    .w-custom {
        width: calc((100vw - 180px - (28px * 6)) / 7);
    }
