<template>
    <div class="relative">
        <div v-if="isAuthenticated" class="pointer-events-auto relative cursor-pointer overflow-hidden px-0 transition-all duration-300 ease-in-out button !gap-0" @click="toggleDropdown"
