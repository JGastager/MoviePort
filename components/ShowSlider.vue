<template>
    <div>
        ...
        <TransitionScale v-drag-scroll appear group tag="div" class="flex items-start overflow-x-auto pb-1 scrollbar-none gap" :class="overflow ? 'px-margin -mx-margin' : 'rounded'">
