<template>
    <div>
        <div class="grid grid-cols-10 mb-30 gap-15">
            <div
                class="group relative col-span-2 aspect-2/1 cursor-pointer overflow-hidden rounded"
            >
                <img
            ...
            >
                <Transition name="fade-image" appear>
                    <img
                        v-if="
                            popularShows?.length && popularShows[0].poster_path
                        "
                        :src="
                            $getImageUrl(
                                popularShows[0].poster_path,
                                'poster',
                                'w342',
                            )
                        "
